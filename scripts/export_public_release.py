...
DATA_FILES = {
    ...
    "data/evaluation/v19/formal/authoring_receipt.json",
    "data/evaluation/v19/formal/calibration_queries_draft.csv",
    ...
    "data/evaluation/v19/formal/holdout_authorization.json",
    "data/evaluation/v19/formal/holdout_claim.json",
    "data/evaluation/v19/formal/holdout_queries_draft.csv",
    ...
    "data/evaluation/v19/formal/holdout_results_receipt.json",
    "data/evaluation/v19/formal/method_lock.json",
    "data/evaluation/v19/formal/primary_review_freeze_receipt.json",
    "data/evaluation/v19/formal/query_families_draft.jsonl",
